...
(function($) {
    $.fn.scrollbar = function(params) {
        ...
        params = $.extend( {
            ...
            //pas:10,                         //Pas du scroll molette - /!\ Doit être un nombre ou 'auto'
            ...
            marge_scroll_contenu: 30,       //Marge entre la scrollBar et le contenu - /!\ Doit être un nombre
        ...
        return this.each(function() {
            ...
            function calcul_contenu_top_max(){
                ...
                //var taille_contenu = $$.height()+140;
                //taille_contenu = $('#inner_contenu').height() + 140;
                //alert(taille_contenu);

                return  /*params.taille_englobe*/ $( window ).height() - taille_contenu ;
            }
            ...
            taille_contenu = Math.round($$.height()*1) + 140;
            /*alert(taille_contenu);*/
            ...
            function calcul_hauteur_auto(){
                if(params.taille_englobe == "auto"){
                    ...
                    params.taille_englobe = $('#html_fullscreen').height()-40-padBot-padTop;
                ...
                if(params.molette){
                    ...
                    setInterval(function(){
                            ...
                            if(mtop_contenu!=0) {
                                ...
                                top_contenu += mtop_contenu;
                                mtop_contenu = Math.round(mtop_contenu);
                                mtop_contenu = mtop_contenu / 1.4;
                                if (mtop_contenu > -1 && mtop_contenu < 1)mtop_contenu = 0;
