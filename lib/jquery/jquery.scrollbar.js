...
(function($) {
	$.fn.scrollbar = function(params) {
		...
		params = $.extend( {
			...
			taille_bouton: 100,				//Taille du bouton - /!\ Doit être un nombre
			pas:77,							//Pas du scroll molette - /!\ Doit être un nombre ou 'auto'
		...
		return this.each(function() {
			...
			function calcul_hauteur_auto(){
				if(params.taille_englobe == "auto"){
					...
					params.taille_englobe = ($(/*window*/'#html_fullscreen').height()/*-118-22+13*/)-40-padBot-padTop;
