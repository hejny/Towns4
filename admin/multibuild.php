...
<b>func:</b><input name="func" id="func" type="text" value="<?php if($_POST['func']){echo($_POST['func']);}else{echo(sql_1data("SELECT id FROM [mpx]objects WHERE name='{building_master_wall}' and own=".$GLOBALS['ss']['useid']).'.create');} ?>">
