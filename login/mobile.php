...
<?php
	...
	if($GLOBALS['url_param']!='fbonly'){
		...
		xreport();
		if(!$_POST['login_username']){hydepark();}
		br();
		...
		if(!$_POST['login_username'])ihydepark();
...
<div style="position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:3;">
<?php
imge('design/wallm.png','','100%');
br();
imge('design/black.png','','100%',250);
?>
</div>
<?php /**/ ?>
